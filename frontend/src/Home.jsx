                ...
                <div className="steps-card">
                    ...
                    <div className="step-list">
                        ...
                        <div className="step-item">
                            ...
                            <div>
                                Connect to your Node.js server at <span className="code-snippet">http://localhost:6000</span>
                            </div>
                        </div>
                        ...
                        <div className="step-item">
                            ...
                            <div>
                                Run with: <span className="code-snippet">docker run -p 6000:6000 node-todo-app</span>
                            </div>
                        </div>
                    </div>
                </div>
